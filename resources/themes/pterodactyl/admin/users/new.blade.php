...
@section('content-header')
    <h1>创建用户<small>向此系统添加新用户。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name_first" class="control-label">客户姓</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">客户名</label>
                        <div>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>提供一个用户密码是可选的。对于新用户，将会使用邮件提示他们来创建一个新的密码。如果在此提供了密码，你将需要通过其他的方式将密码告知于用户。</p>
                    </div>
