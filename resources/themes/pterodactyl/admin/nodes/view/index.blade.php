...
@section('content-header')
    <h1>{{ $node->name }}<small>快速预览你的节点。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">删除节点是不可逆的操作，它将立即从面板中删除该节点。必须没有与此节点关联的服务器才能继续。</p>
                    </div>
                    <div class="box-footer">
                        <form action="{{ route('admin.nodes.view.delete', $node->id) }}" method="POST">
                            {!! csrf_field() !!}
                            {!! method_field('DELETE') !!}
                            <button type="submit" class="btn btn-danger btn-sm pull-right" {{ ($node->servers_count < 1) ?: 'disabled' }}>好的，删除这个节点</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-orange">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">此节点正处于</span>
                                <span class="info-box-number">维护</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['disk']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">已分配的磁盘空间</span>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['memory']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">已分配的内存</span>
