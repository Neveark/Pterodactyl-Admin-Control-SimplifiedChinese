...
@section('content-header')
    <h1>包<small>此系统上所有可用的服务包。</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">管理</a></li>
        <li class="active">包</li>
    </ol>
@endsection
                    ...
                    <form action="{{ route('admin.packs') }}" method="GET">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="{{ route('admin.packs.new') }}"><button type="button" class="btn btn-sm btn-primary" style="border-radius: 0 3px 3px 0;margin-left:-1px;">创建新的</button></a>
                            </div>
                        </div>
                    </form>
                </div>
