...
@section('title')
    服务器 — {{ $server->name }}: Build Details
@endsection

@section('content-header')
    <h1>{{ $server->name }}<small>控制此服务器的分配以及系统资源。</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                @if($server->installed === 1)
                    ...
                    <li class="active"><a href="{{ route('admin.servers.view.build', $server->id) }}">构建配置</a></li>
